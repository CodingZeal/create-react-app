...
prompt(
  ...
  // ZEAL: We don't need this; see below for details
  ...
  // Add ESlint config
  // ZEAL: We rely on the host project for its eslint configuration, so there
  // is no need to do anything with the local eslintconfig, because we never
  // use it.
